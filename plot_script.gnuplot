...
plot "sorting_times.txt" using 1:2 with lines title "Bubble Sort", \
     ...
     "sorting_times.txt" using 1:5 with lines title "Merge Sort" ,\
     "sorting_times.txt" using 1:6 with lines title "Quick Sort" ,\
     "sorting_times.txt" using 1:7 with lines title "Selection Sort" ,\
     "sorting_times.txt" using 1:8 with lines title "Redix Sort" ,\